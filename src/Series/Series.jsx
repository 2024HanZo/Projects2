    ...
    return(
      //card ta3 do
        <div className="all">
         ...
         {color.check === false && res.lenght !== 0 ? <div className="sun">

          <button onClick={() => {setColor({check:true})}}><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-brightness-low-fill" viewBox="0 0 16 16">
          ...
          //card ta3 dlam
          : color.check === true && res.lenght !== 0 ? 
          <div className="moon">

          <button onClick={() => {setColor({check:false})}}>
