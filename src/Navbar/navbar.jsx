            ...
            <nav>
                    ...
                    <div className={change} >
                        ...
                        <button className="btnNav"  onClick={() => {
                            if(change === "black"){dispatch(changeColorWhite())}
                            else{dispatch(changeColorDark())}
                        }}>
                        {change === "white" ? <svg xmlns="http://www.w3.org/2000/svg" width="100" height="50" fill="currentColor" class="bi bi-moon-stars" viewBox="0 0 10 20">
...
</svg> : <svg className="sunny" xmlns="http://www.w3.org/2000/svg" width="100" height="50" fill="white" class="bi bi-brightness-high" viewBox="0 0 10 20">
